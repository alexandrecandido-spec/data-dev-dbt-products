...
# Crear el DAG frecuencia semanal lunes 11am
dag = create_dbt_dag(
    dag_id='dbt_partners_weekly-monday-11am',
    schedule_interval_tag='weekly-monday-11am',
    default_args=default_args,
    tags=['partners', 'weekly-monday-11am']
)
