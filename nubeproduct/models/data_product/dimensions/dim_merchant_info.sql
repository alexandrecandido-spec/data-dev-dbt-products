...
LEFT JOIN {{ ref('_int_dim_merchant_info__location_by_zipcode') }} AS c ON a.store_id = c.store_id
LEFT JOIN {{ ref('_int_dim_merchant_info__segment') }} AS d ON a.store_id = d.store_id
