...
with metafield_orders as (
    ...
    updated_at,
    deleted_at
    FROM {{ source('stg_metafields', 'metafield_orders') }} AS mpv
    {% if is_incremental() %}
...
LEFT JOIN existing_data e ON metafield_orders.uuid = e.uuid