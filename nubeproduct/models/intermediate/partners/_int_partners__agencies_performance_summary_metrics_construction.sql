...
(
    SELECT 
        ...
        -- Rolling periods
        SUM(CASE WHEN created_at >= DATE_SUB(snapshot_date, 30) THEN 1 ELSE 0 END) AS trials_last_30d, 
        SUM(CASE WHEN first_payment_flg = TRUE AND first_payment >= DATE_SUB(snapshot_date, 30) THEN 1 ELSE 0 END) AS new_payments_last_30d,
        SUM(CASE WHEN first_seller_at >= DATE_SUB(snapshot_date, 30) THEN 1 ELSE 0 END) AS new_sellers_last_30d,
        ...
        SUM(CASE WHEN created_at >= DATE_SUB(snapshot_date, 90) THEN 1 ELSE 0 END) AS trials_last_90d,
        SUM(CASE WHEN first_payment_flg = TRUE AND first_payment >= DATE_SUB(snapshot_date, 90) THEN 1 ELSE 0 END) AS new_payments_last_90d,
        SUM(CASE WHEN first_seller_at >= DATE_SUB(snapshot_date, 90) THEN 1 ELSE 0 END) AS new_sellers_last_90d,
        ...
        SUM(CASE WHEN created_at >= DATE_SUB(snapshot_date, 180) THEN 1 ELSE 0 END) AS trials_last_180d,
        SUM(CASE WHEN first_payment_flg = TRUE AND first_payment >= DATE_SUB(snapshot_date, 180) THEN 1 ELSE 0 END) AS new_payments_last_180d,
        SUM(CASE WHEN first_seller_at >= DATE_SUB(snapshot_date, 180) THEN 1 ELSE 0 END) AS new_sellers_last_180d,
        ...
        SUM(CASE WHEN created_at >= DATE_SUB(snapshot_date, 365) THEN 1 ELSE 0 END) AS trials_last_365d,
        SUM(CASE WHEN first_payment_flg = TRUE AND first_payment >= DATE_SUB(snapshot_date, 365) THEN 1 ELSE 0 END) AS new_payments_last_365d,
