...
SELECT 
    ...
    SUM(CASE WHEN first_seller_at >= DATE_SUB(CURRENT_DATE(), 30) THEN 1 ELSE 0 END) AS new_sellers_last_30d,
    SG.gmv_usd_last_30d,
    ...
    SUM(CASE WHEN first_seller_at >= DATE_SUB(CURRENT_DATE(), 90) THEN 1 ELSE 0 END) AS new_sellers_last_90d,
    SG.gmv_usd_last_90d,
    ...
    SUM(CASE WHEN first_seller_at >= DATE_SUB(CURRENT_DATE(), 180) THEN 1 ELSE 0 END) AS new_sellers_last_180d,
    ...
    SUM(CASE WHEN first_seller_at >= DATE_SUB(CURRENT_DATE(), 365) THEN 1 ELSE 0 END) AS new_sellers_last_365d,
