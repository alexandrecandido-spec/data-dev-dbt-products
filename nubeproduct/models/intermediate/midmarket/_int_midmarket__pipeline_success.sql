select
  ...
  d.date_entered_effective_churn_ar,
  d.date_entered_effective_churn_br,
  d.date_entered_effective_churn_mx,
  d.date_entered_transition_to_customer_success_onboarding__ar,
  d.date_entered_transition_to_customer_success_onboarding__br,
  d.date_entered_warning_ar,
  d.date_entered_warning_br,
  d.date_entered_warning_mx,
  d.date_exited_effective_churn_br,
  d.date_exited_effective_churn_ar,
  d.date_exited_warning_ar,
  d.date_exited_warning_br,
  d.date_exited_warning_mx,
  d.deadline_goal,
...
WHERE dd.deal_id IS NULL
  AND d.pipeline IN ('Success | AR', 'Success | BR', 'Success | MX')