with
	onboarding_churns as
        (select distinct
            ...
            o.onboarding_churn_month as date_month,
        ...
        where 
            o.onboarding_churn_month is not null
            and o.pipeline in 
                ('Onboarding | AR',
                'Onboarding | BR',
                'Onboarding | MX')),
	onboarding_downgrades as
		(select distinct
            ...
            o.onboarding_downgrade_month as date_month,
            --case when o.country = 'AR' then o.potential_gmv / fc.value_local_currency else null end as potential_gmv_usd,
            /*case
                when o.country = 'BR' then
                    case 
    	...
    	from {{ ref('midmarket__general__closing_pack_hubspot_deals') }} as o
    		...
    		left join {{ ref('company_metrics_merchant_info') }} as mi
				on o.store_id = mi.store_id
        where 
            o.onboarding_downgrade_month is not null
            and o.pipeline in 
                ('Onboarding | AR',
                'Onboarding | BR',
                'Onboarding | MX')),
	onboarding_go_lives as
		(select distinct
			...
			o.onboarding_go_live_month as date_month,
            --case when o.country = 'AR' then o.potential_gmv / fc.value_local_currency else null end as potential_gmv_usd,
            /*case
                when o.country = 'BR' then
                    case 
    	...
    	from {{ ref('midmarket__general__closing_pack_hubspot_deals') }} as o
			...
			left join {{ ref('company_metrics_merchant_info') }} as mi
				on o.store_id = mi.store_id
        where 
            o.onboarding_go_live_month is not null
          	and o.pipeline in 
                ('Onboarding | AR',
                'Onboarding | BR',
                'Onboarding | MX'))
